                    ...
                    <form action="" method="post">
                        <table width ="70%">
                            ...
                            <tr>
                                ...
                                <td><input style="width:140% ; margin-top :3px"  type="password" name="password" id="password"required></td>
                            </tr>
                            <tr>
                                <td><label for="password2">Konfirmasi Password</label></td>
                                <td><input style="width:140% ; margin-top :3px"  type="password" name="password2" id="password2"required></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td><button style="width:40% ; margin-top :3px"  type="submit" name="ubahpassword"required>kirim</button></td> 
                            </tr>
                        </table>
                    </form>
                </div>
